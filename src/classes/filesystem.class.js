            ...
            blockList.forEach(e => {
                ...
                filesDOM += `<div class="fs_disp_${e.type}${hidden} animationWait" onclick="${cmd}">
                                <svg viewBox="0 0 24.00 24.00">
                                    <path fill="${this.iconcolor}" fill-opacity="1" d="${icon}"/>
                                </svg>
                                <h3>${e.name}</h3>
                            </div>`;
            });
