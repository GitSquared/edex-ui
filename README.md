...
Download 1.0.1: [for Windows](https://github.com/GitSquared/edex-ui/releases/download/v1.0.1/eDEX-UI.Windows.Installer.exe) | [for macOS](https://github.com/GitSquared/edex-ui/releases/download/v1.0.1/eDEX-UI.MacOS.Image.dmg) | [for Linux x32](https://github.com/GitSquared/edex-ui/releases/download/v1.0.1/eDEX-UI.Linux.i386.AppImage) | [for Linux x64](https://github.com/GitSquared/edex-ui/releases/download/v1.0.1/eDEX-UI.Linux.x86_64.AppImage)
